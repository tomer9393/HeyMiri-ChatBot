...
section {
  ...
  *::after {
  ...
  #reply-message:active ~ #reply-box {
    display: flex;
  } */
...
.chat-messages .message .myMeta {
  ...
  .chat-messages .message .myMeta span,
